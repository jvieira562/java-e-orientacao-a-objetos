...
public class TesteListas {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Inserção na ArrayList demorou  \t" + tempoArrayList + " segundos");
        System.out.println("Inserção na LinkedList demorou \t" + tempoLinkedList + " segundos");

        tempoArrayList = removePrimeirosElementos(numerosArrayList);
        tempoLinkedList = removePrimeirosElementos(numerosLinkedList);

        System.out.println("Remoção da ArrayList demorou  \t" + tempoArrayList + " segundos");
        System.out.println("Remoção da LinkedList demorou \t" + tempoLinkedList + " segundos");
    }
